...
public class UtilChatColour {
    ...
    public static MutableComponent parse(String message) {
        ...
        try {
            ...
            // Use ComponentSerialization.CODEC for MC 26.1+
            com.google.gson.JsonElement jsonElement = com.google.gson.JsonParser.parseString(json);
            return (MutableComponent) net.minecraft.network.chat.ComponentSerialization.CODEC.parse(com.mojang.serialization.JsonOps.INSTANCE, jsonElement).getOrThrow();
        } catch (Exception e) {
