package com.strictgaming.elite.holograms.neo262;
...
import com.strictgaming.elite.holograms.neo262.command.CommandFactory;
import com.strictgaming.elite.holograms.neo262.command.HologramsAnimateLineCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsBackgroundCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsBacklightCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsCreateCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsCreateItemCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsDeleteCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsListCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsMoveHereCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsMoveToCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsCreateAtCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsReloadCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsTeleportCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsAddLineCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsSetLineCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsRemoveLineCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsNearCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsInfoCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsCopyCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsInsertLineCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsCreateScoreboardCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsSetThemeCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsMoveVerticalCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsSetRotationCommand;
import com.strictgaming.elite.holograms.neo262.command.HologramsConvertCommand;
import com.strictgaming.elite.holograms.neo262.config.HologramsConfig;
import com.strictgaming.elite.holograms.neo262.hologram.HologramManager;
import com.strictgaming.elite.holograms.neo262.hologram.manager.NeoForgeHologramFactory;
import com.strictgaming.elite.holograms.neo262.hologram.manager.NeoForgeHologramManager;
...
@Mod(Neo262Holograms.MOD_ID)
public class Neo262Holograms implements PlatformHologramManager {
     ...
     * no manifest to read.
     */
    public static final String VERSION = Neo262Holograms.class.getPackage().getImplementationVersion() != null
            ? Neo262Holograms.class.getPackage().getImplementationVersion()
            : "dev";
    private static final Logger LOGGER = LogUtils.getLogger();

    private static Neo262Holograms instance;
    ...
    public Neo262Holograms(IEventBus modEventBus, ModContainer modContainer) {
        instance = this;
        LOGGER.info("Initializing Elite Holograms mod for Minecraft 26.2");
    ...
    public void onServerStarted(ServerStartedEvent event) {
        ...
        com.strictgaming.elite.holograms.neo262.util.UtilPlaceholder.setServerStartTime();
    ...
    public static Neo262Holograms getInstance() {
        return instance;
    }
