    ...
    public int run(CommandContext<CommandSourceStack> context, HologramDisplayType displayType) {
        ...
        try {
            ...
            if (theme == null || theme.trim().isEmpty()) {
                theme = com.strictgaming.elite.holograms.fabric.config.ScoreboardThemeManager.getDefaultThemeName();
            }
            if (com.strictgaming.elite.holograms.fabric.config.ScoreboardThemeManager.getTheme(theme) == null) {
