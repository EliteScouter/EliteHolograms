...
public class FabricHologramTypeAdapter implements JsonSerializer<FabricHologram>, JsonDeserializer<FabricHologram> {
    ...
    // ... getLocationObject ...
    private JsonObject getLocationObject(FabricHologram hologram) {
        JsonObject object = new JsonObject();
    ...
    @Override
    public FabricHologram deserialize(JsonElement element, Type type, JsonDeserializationContext context) throws JsonParseException {
        try {
