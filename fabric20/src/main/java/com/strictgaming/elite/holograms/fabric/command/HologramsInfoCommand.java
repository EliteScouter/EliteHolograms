...
public class HologramsInfoCommand implements Command<CommandSourceStack> {
    ...
    public int executeCommand(CommandContext<CommandSourceStack> context, String[] args) throws CommandSyntaxException {
        ...
        try {
            ...
            if (hologram instanceof com.strictgaming.elite.holograms.fabric.hologram.FabricHologram infoHologram) {
                ...
                if (infoHologram.getDisplayType()
                        == com.strictgaming.elite.holograms.fabric.hologram.HologramDisplayType.FIXED) {
