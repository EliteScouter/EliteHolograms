...
| `eliteholograms.edit` | Edit hologram content | `/eh addline`, `/eh setline`, `/eh removeline`, `/eh insertline`, `/eh movehere`, `/eh movevertical`, `/eh convert`, `/eh setrotation`, `/eh background` |
